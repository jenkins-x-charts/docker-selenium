...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-charts/docker-selenium/trunk/22'
...
export MINK_IMAGE='ghcr.io/jenkins-x/docker-selenium:4.17.0'
