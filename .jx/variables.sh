...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-charts/docker-selenium/trunk/14'
...
export MINK_IMAGE='ghcr.io/jenkins-x/docker-selenium:4.11.2'
