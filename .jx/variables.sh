...
export APP_NAME='docker-selenium'
...
export GIT_BRANCH='trunk'
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-charts/docker-selenium/trunk/35'
